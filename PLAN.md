...
- Revenue: starts ~12,000 k€, grows ~5–7%/yr with mild noise → ~18,000 k€ by 2025.
- Each cost category is produced as `α·(1+v)^(t−t0) + β·Revenue_t + noise`, with true parameters:

| Category | α (k€, 2016) | v | β | noise σ |
|---|---|---|---|---|
| Material costs | 400 | 2.0% | 0.060 | 1.5% |
| External services | 250 | 3.0% | 0.045 | 2.0% |
| Personnel costs | 6,000 | 2.8% | 0.300 | 1.0% |
| Other costs (excl. depreciation) | 700 | 2.5% | 0.030 | 2.0% |

  This keeps personnel ≈ 80% of total costs, matching the PDF.
